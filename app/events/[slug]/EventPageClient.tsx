...
export default function EventPageClient({
  ...
  return h("div", { className: "min-h-screen" },
               h("section", { className: "relative px-5 sm:px-10 pt-16 pb-10" },
                       h("p", { className: "font-sans text-[11px] font-bold uppercase tracking-[0.28em] text-crimson" }, "The Menkeys Production presente"),
                       h("h1", { className: "font-display leading-[0.9] text-[15vw] sm:text-7xl mt-2" }, event.name),
                       h("div", { className: "flex flex-wrap gap-x-8 gap-y-3 mt-8 text-sm" },
                       ...
                       h("p", { className: "max-w-xl mt-6 text-sm leading-relaxed text-muted" }, event.description)
                     ),
               ...
               h("section", { className: "px-5 sm:px-10 py-12" },
                       ...
                       h("div", { className: "grid sm:grid-cols-3 gap-5" },
                                 ticketTypes.map((t) => {
               ...
               selected && h("div", { className: "fixed inset-0 z-30 flex items-center justify-center p-4", style: { background: "rgba(10,10,10,0.92)" } },
                                   h("div", { className: "w-full sm:max-w-md max-h-[92vh] overflow-y-auto p-6 sm:p-8 relative bg-surface border border-line" },
                                             ...
                                             step === 1 && h("div", { className: "space-y-3" },
                                                                       h("div", {},
                                             ...
                                             step === 2 && h("div", {},
                                                                       ...
                                                                       error && h("p", { className: "text-xs text-crimson mb-4" }, error),
